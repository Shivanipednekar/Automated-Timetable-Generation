...
public class timetablescript {
   ...
   // String[] subjects=new String[20]; //data frpm database
    ...
    String[] getAssignableSub(String[] day){
       ...
       if((day==null))// if(isSubAssignable(day,subj)) //define
        return subj;
    else
    ...
    public static void main(String[] args){
        // int slots=8;
    //String[] subj=new String[]{"DS","CCNS","ADSA","CC"};
   // String[] day=new String[16];
        timetablescript t=new timetablescript();
        
        t.newempday();
        t.isSubAssignable(day,subj);  //error
        t.getAssignableSub(day); //error
        t.assignSlot(day,subj);  //error
        t.newDay();
    }
